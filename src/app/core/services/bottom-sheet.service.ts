...
import { UiBottomSheetHostComponent } from '../../shared/ui-bottom-sheet/ui-bottom-sheet-host.component';
...
export class BottomSheetService {
  ...
  open<TData, TResult>(
    ...
    const hostRef = createComponent(UiBottomSheetHostComponent, {
  ...
  private attachToDom(hostRef: ComponentRef<UiBottomSheetHostComponent>): void {
    this.appRef.attachView(hostRef.hostView);
    document.body.appendChild(hostRef.location.nativeElement);
  }

  private detachFromDom(hostRef: ComponentRef<UiBottomSheetHostComponent>): void {
