...
export class MockFirestoreService {
  ...
  private seed(): void {
    ...
    const ingredients: Ingredient[] = [
      { id: 'ing-1', name: 'Azúcar', unit: 'kg', unitPrice: 600, currentStock: 10, minimumStock: 3, category: 'sugars', lastPurchase: ts(2026, 5, 20), active: true },
      { id: 'ing-2', name: 'Cacao amargo', unit: 'kg', unitPrice: 5200, currentStock: 1.5, minimumStock: 1, category: 'dry', lastPurchase: ts(2026, 5, 18), active: true },
      { id: 'ing-3', name: 'Chocolate cobertura', unit: 'kg', unitPrice: 7500, currentStock: 0.8, minimumStock: 1, category: 'decoration', lastPurchase: ts(2026, 5, 15), active: true },
      { id: 'ing-4', name: 'Crema de leche', unit: 'lt', unitPrice: 2800, currentStock: 4, minimumStock: 2, category: 'dairy', lastPurchase: ts(2026, 5, 22), active: true },
      { id: 'ing-5', name: 'Dulce de leche', unit: 'kg', unitPrice: 3200, currentStock: 2, minimumStock: 1, category: 'dairy', lastPurchase: ts(2026, 5, 20), active: true },
      { id: 'ing-6', name: 'Esencia de vainilla', unit: 'ml', unitPrice: 15, currentStock: 200, minimumStock: 50, category: 'other', lastPurchase: ts(2026, 5, 10), active: true },
      { id: 'ing-7', name: 'Harina 0000', unit: 'kg', unitPrice: 800, currentStock: 15, minimumStock: 5, category: 'dry', lastPurchase: ts(2026, 5, 22), active: true },
      { id: 'ing-8', name: 'Huevos', unit: 'unit', unitPrice: 150, currentStock: 48, minimumStock: 12, category: 'eggs', lastPurchase: ts(2026, 5, 24), active: true },
      { id: 'ing-9', name: 'Leche', unit: 'lt', unitPrice: 900, currentStock: 8, minimumStock: 4, category: 'dairy', lastPurchase: ts(2026, 5, 22), active: true },
      { id: 'ing-10', name: 'Manteca', unit: 'kg', unitPrice: 3500, currentStock: 3, minimumStock: 2, category: 'fats', lastPurchase: ts(2026, 5, 20), active: true },
    ];

    // --- Recipes (sorted by name asc) ----------------------------------------
    const recipes: Recipe[] = [
      {
        id: 'rec-1', name: 'Alfajores de Maicena (x12)', category: 'cookies',
        ingredients: [
        ...
        calculatedCost: 2760, profitMargin: 70, suggestedPrice: 4692, salePrice: 4500, yield: 12, notes: 'Clásicos argentinos', imageUrl: '', active: true,
      },
      {
        id: 'rec-2', name: 'Budín de Limón', category: 'breads',
        ingredients: [
        ...
        calculatedCost: 1400, profitMargin: 80, suggestedPrice: 2520, salePrice: 2500, yield: 8, notes: 'Con glasé de limón', imageUrl: '', active: true,
      },
      {
        id: 'rec-3', name: 'Cheesecake', category: 'pies',
        ingredients: [
        ...
        calculatedCost: 3725, profitMargin: 65, suggestedPrice: 6147, salePrice: 6500, yield: 10, notes: 'Base de galletitas', imageUrl: '', active: true,
      },
      {
        id: 'rec-4', name: 'Torta de Chocolate', category: 'cakes',
        ingredients: [
        ...
        calculatedCost: 4725, profitMargin: 60, suggestedPrice: 7560, salePrice: 7500, yield: 12, notes: 'La más pedida', imageUrl: '', active: true,
      },
    ];

    // --- Customers (sorted by name asc) --------------------------------------
    const customers: Customer[] = [
      { id: 'cli-1', name: 'Ana Martínez', phone: '1162345678', address: 'Av. Alvear 1800, Recoleta', notes: 'Siempre pide budín para eventos', totalPurchases: 4, lastPurchase: ts(2026, 5, 25) },
      { id: 'cli-2', name: 'Carlos Rodríguez', phone: '1148765432', address: 'Av. Cabildo 1500, Belgrano', notes: '', totalPurchases: 1, lastPurchase: ts(2026, 5, 8) },
      { id: 'cli-3', name: 'Lucía Fernández', phone: '1171234567', address: 'Av. Rivadavia 5400, Caballito', notes: 'Pedidos para oficina', totalPurchases: 6, lastPurchase: ts(2026, 5, 24) },
      { id: 'cli-4', name: 'María López', phone: '1155234567', address: 'Av. Santa Fe 3200, Palermo', notes: 'Clienta frecuente, prefiere chocolate', totalPurchases: 4, lastPurchase: ts(2026, 5, 26) },
    ];
    ...
    const sales: Sale[] = [
      ...
      { id: 'ven-1', date: ts(2026, 5, 2), customerId: 'cli-3', customerName: 'Lucía Fernández', items: [
      ...
      ], total: 11000, totalCost: 6485, profit: 4515, paymentMethod: 'transfer', status: 'delivered', notes: '' },
      { id: 'ven-2', date: ts(2026, 5, 6), customerId: 'cli-3', customerName: 'Lucía Fernández', items: [
      ...
      ], total: 20500, totalCost: 12175, profit: 8325, paymentMethod: 'mercadopago', status: 'delivered', notes: '' },
      { id: 'ven-3', date: ts(2026, 5, 10), customerId: 'cli-3', customerName: 'Lucía Fernández', items: [
        { recipeId: 'rec-1', name: 'Alfajores de Maicena (x12)', quantity: 4, unitPrice: 4500, unitCost: 2760 },
      ], total: 18000, totalCost: 11040, profit: 6960, paymentMethod: 'transfer', status: 'delivered', notes: '' },
      { id: 'ven-4', date: ts(2026, 5, 15), customerId: 'cli-3', customerName: 'Lucía Fernández', items: [
        { recipeId: 'rec-4', name: 'Torta de Chocolate', quantity: 1, unitPrice: 7500, unitCost: 4725 },
        { recipeId: 'rec-2', name: 'Budín de Limón', quantity: 2, unitPrice: 2500, unitCost: 1400 },
      ], total: 12500, totalCost: 7525, profit: 4975, paymentMethod: 'cash', status: 'delivered', notes: '' },
      { id: 'ven-5', date: ts(2026, 5, 20), customerId: 'cli-3', customerName: 'Lucía Fernández', items: [
        { recipeId: 'rec-1', name: 'Alfajores de Maicena (x12)', quantity: 5, unitPrice: 4500, unitCost: 2760 },
      ], total: 22500, totalCost: 13800, profit: 8700, paymentMethod: 'transfer', status: 'delivered', notes: '' },
      { id: 'ven-6', date: ts(2026, 5, 24), customerId: 'cli-3', customerName: 'Lucía Fernández', items: [
        { recipeId: 'rec-3', name: 'Cheesecake', quantity: 1, unitPrice: 6500, unitCost: 3725 },
        { recipeId: 'rec-4', name: 'Torta de Chocolate', quantity: 1, unitPrice: 7500, unitCost: 4725 },
      ], total: 14000, totalCost: 8450, profit: 5550, paymentMethod: 'mercadopago', status: 'pending', notes: 'Entregar a las 17hs' },

      // Ana Martínez (cli-1) — 4 purchases, $64,500 → tier 'medio'
      { id: 'ven-7', date: ts(2026, 5, 3), customerId: 'cli-1', customerName: 'Ana Martínez', items: [
        { recipeId: 'rec-1', name: 'Alfajores de Maicena (x12)', quantity: 5, unitPrice: 4500, unitCost: 2760 },
        { recipeId: 'rec-2', name: 'Budín de Limón', quantity: 2, unitPrice: 2500, unitCost: 1400 },
      ], total: 27500, totalCost: 16600, profit: 10900, paymentMethod: 'mercadopago', status: 'delivered', notes: 'Para cumpleaños' },
      { id: 'ven-8', date: ts(2026, 5, 11), customerId: 'cli-1', customerName: 'Ana Martínez', items: [
        { recipeId: 'rec-3', name: 'Cheesecake', quantity: 3, unitPrice: 6500, unitCost: 3725 },
      ], total: 19500, totalCost: 11175, profit: 8325, paymentMethod: 'mercadopago', status: 'delivered', notes: '' },
      { id: 'ven-9', date: ts(2026, 5, 18), customerId: 'cli-1', customerName: 'Ana Martínez', items: [
        { recipeId: 'rec-4', name: 'Torta de Chocolate', quantity: 1, unitPrice: 7500, unitCost: 4725 },
        { recipeId: 'rec-2', name: 'Budín de Limón', quantity: 2, unitPrice: 2500, unitCost: 1400 },
      ], total: 12500, totalCost: 7525, profit: 4975, paymentMethod: 'cash', status: 'delivered', notes: '' },
      { id: 'ven-10', date: ts(2026, 5, 25), customerId: 'cli-1', customerName: 'Ana Martínez', items: [
        { recipeId: 'rec-2', name: 'Budín de Limón', quantity: 2, unitPrice: 2500, unitCost: 1400 },
      ], total: 5000, totalCost: 2800, profit: 2200, paymentMethod: 'cash', status: 'delivered', notes: '' },

      // María López (cli-4) — 4 purchases, $44,000 → tier 'medio' (≥3 orders)
      { id: 'ven-11', date: ts(2026, 5, 4), customerId: 'cli-4', customerName: 'María López', items: [
        { recipeId: 'rec-1', name: 'Alfajores de Maicena (x12)', quantity: 2, unitPrice: 4500, unitCost: 2760 },
        { recipeId: 'rec-2', name: 'Budín de Limón', quantity: 1, unitPrice: 2500, unitCost: 1400 },
      ], total: 11500, totalCost: 6920, profit: 4580, paymentMethod: 'transfer', status: 'delivered', notes: '' },
      { id: 'ven-12', date: ts(2026, 5, 12), customerId: 'cli-4', customerName: 'María López', items: [
        { recipeId: 'rec-4', name: 'Torta de Chocolate', quantity: 1, unitPrice: 7500, unitCost: 4725 },
      ], total: 7500, totalCost: 4725, profit: 2775, paymentMethod: 'mercadopago', status: 'delivered', notes: '' },
      { id: 'ven-13', date: ts(2026, 5, 19), customerId: 'cli-4', customerName: 'María López', items: [
        { recipeId: 'rec-3', name: 'Cheesecake', quantity: 1, unitPrice: 6500, unitCost: 3725 },
        { recipeId: 'rec-2', name: 'Budín de Limón', quantity: 2, unitPrice: 2500, unitCost: 1400 },
      ], total: 11500, totalCost: 6525, profit: 4975, paymentMethod: 'cash', status: 'delivered', notes: '' },
      { id: 'ven-14', date: ts(2026, 5, 26), customerId: 'cli-4', customerName: 'María López', items: [
        { recipeId: 'rec-1', name: 'Alfajores de Maicena (x12)', quantity: 3, unitPrice: 4500, unitCost: 2760 },
      ], total: 13500, totalCost: 8280, profit: 5220, paymentMethod: 'transfer', status: 'delivered', notes: '' },

      // Carlos Rodríguez (cli-2) — 1 purchase, $11,000 → tier 'bajo'
      { id: 'ven-15', date: ts(2026, 5, 8), customerId: 'cli-2', customerName: 'Carlos Rodríguez', items: [
        { recipeId: 'rec-3', name: 'Cheesecake', quantity: 1, unitPrice: 6500, unitCost: 3725 },
        { recipeId: 'rec-1', name: 'Alfajores de Maicena (x12)', quantity: 1, unitPrice: 4500, unitCost: 2760 },
      ], total: 11000, totalCost: 6485, profit: 4515, paymentMethod: 'cash', status: 'delivered', notes: '' },

      // Consumidor final (sin customerId) — anónimo
      { id: 'ven-16', date: ts(2026, 5, 16), customerId: null, customerName: 'Consumidor final', items: [
        { recipeId: 'rec-2', name: 'Budín de Limón', quantity: 3, unitPrice: 2500, unitCost: 1400 },
        { recipeId: 'rec-4', name: 'Torta de Chocolate', quantity: 1, unitPrice: 7500, unitCost: 4725 },
      ], total: 15000, totalCost: 8925, profit: 6075, paymentMethod: 'cash', status: 'delivered', notes: '' },
      { id: 'ven-17', date: ts(2026, 5, 28), customerId: null, customerName: 'Consumidor final', items: [
        { recipeId: 'rec-1', name: 'Alfajores de Maicena (x12)', quantity: 3, unitPrice: 4500, unitCost: 2760 },
      ], total: 13500, totalCost: 8280, profit: 5220, paymentMethod: 'cash', status: 'delivered', notes: '' },
      { id: 'ven-18', date: ts(2026, 5, 30), customerId: null, customerName: 'Consumidor final', items: [
        { recipeId: 'rec-3', name: 'Cheesecake', quantity: 1, unitPrice: 6500, unitCost: 3725 },
        { recipeId: 'rec-2', name: 'Budín de Limón', quantity: 1, unitPrice: 2500, unitCost: 1400 },
      ], total: 9000, totalCost: 5125, profit: 3875, paymentMethod: 'cash', status: 'delivered', notes: '' },
    ];
    ...
    this.getOrCreate('supplyExpenses').next([
      { id: 'sup-1', date: ts(2026, 5, 2), description: 'Compra semanal mayorista', supplier: 'Distribuidora Centro', total: 32000, items: [] },
      { id: 'sup-2', date: ts(2026, 4, 18), description: 'Reposicion de lácteos y chocolates', supplier: 'Mercado Norte', total: 24500, items: [] },
      { id: 'sup-3', date: ts(2026, 3, 10), description: 'Compra mensual de secos', supplier: 'Proveedor Sur', total: 18750, items: [] },
    ]);
